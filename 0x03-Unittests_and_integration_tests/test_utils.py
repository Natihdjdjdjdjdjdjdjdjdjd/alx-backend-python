...
class TestAccessNestedMap(TestCase):
    """the attributes to test utils.access_nested_map func"""
    ...
    def test_access_nested_map(self, nested_map, path, res):
        """access_nested_map returns the right result"""

        self.assertEqual(access_nested_map(nested_map, path), res)

    @parameterized.expand([({}, ("a",)), ({"a": 1}, ("a", "b"))])
    def test_access_nested_map_exception(self,  nested_map, path):
        """let accessess access_nested_map """
...
class TestMemoize(TestCase):
    ...
    def test_memoize(self):
        ...
        class TestClass:
            ...
            @memoize
            def a_property(self):
                """Test a property instance of my memoize"""
